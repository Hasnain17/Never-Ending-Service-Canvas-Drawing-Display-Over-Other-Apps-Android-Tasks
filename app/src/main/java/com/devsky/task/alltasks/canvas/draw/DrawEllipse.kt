package com.devsky.task.alltasks.canvas.draw
...
import com.devsky.task.alltasks.activities.CanvasActivity
import com.devsky.task.alltasks.activities.CanvasActivity.Companion.currentBrush
import com.devsky.task.alltasks.canvas.cons.Ellipse
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        when (event.action) {
            MotionEvent.ACTION_DOWN -> {
                CanvasActivity.colorList.add(CanvasActivity.currentBrush)
